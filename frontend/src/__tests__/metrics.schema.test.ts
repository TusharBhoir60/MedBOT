...
const VALID_CONFIDENCE = {
  ...
  distribution: [
    ...
    { range: "[0.4, 0.6)", count: 20 },
    { range: "[0.6, 0.8)", count: 40 },
    { range: "[0.8, 1.0]", count: 25 },
  ],
  agentAverages: [{ agent: "intake", average: 0.8 }],
  conditionAverages: [{ condition: "Flu", average: 0.9, count: 5 }],
...
const VALID_CLINICAL = {
  ...
  severityDistribution: [{ severity: "routine", count: 25 }],
  escalationDistribution: [{ status: "APPROVED", count: 4 }],
  sampleSize: 30,
  generatedAt: "2026-07-09T10:00:00.000Z",
};
